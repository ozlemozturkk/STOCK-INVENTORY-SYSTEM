 ...
 * @author hilal
 */
public class SingInWareHouse extends javax.swing.JFrame {

    /**
     * Creates new form SingIn
     */
    public SingInWareHouse() {
        initComponents();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(passwordTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))
  ...
  String name = nameSurnameTextField.getText();
    ...
    if (success) {
        JOptionPane.showMessageDialog(this, "Warehouse user registered!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SingInWareHouse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SingInWareHouse().setVisible(true);
            }
        });
    }
